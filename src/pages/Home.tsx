...
const Home: React.FC = () => {
  ...
  const movies = [
    ...
    },
    {
      ...
      type: "movie",
      synopsis:
        "Six Dutch Commandos, commanded by John de Koning and stationed in Mali, are sent to Nigeria under American orders to free the son of a wealthy Nigerian oil family from Boko Haram rebels. ...",
    },
    {
      imageurl: [
